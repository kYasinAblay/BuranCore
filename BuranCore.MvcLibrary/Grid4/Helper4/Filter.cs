...
namespace Buran.Core.MvcLibrary.Grid4.Helper4
{
    class Filter4
    {
        ...
        public Filter4(Dictionary<string, StringValues> query, List<KeyValuePair<string, string>> queryItems, string pagerKeyword, RouteData routeData,
